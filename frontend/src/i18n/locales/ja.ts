export default {
  ...
  printers: {
    ...
    toast: {
      ...
      partCollected: 'パーツを回収しました、ビルドプレートをクリアしました',
      failedToCollectPart: 'パーツの回収に失敗しました',
      ...
      partRemovalEnabled: 'パーツ取り出し確認を有効にしました',
      partRemovalDisabled: 'パーツ取り出し確認を無効にしました',
    ...
    partRemoval: {
      title: 'パーツ取り出し確認',
      confirmRemoval: 'パーツ取り出しを確認',
      noRemovalRequired: 'パーツ取り出しは不要です',
      plateCheckDisabledDuringRemoval: 'パーツが回収されるまでプレートチェックは無効です',
      disabledDuringPlateCheck: 'プレートチェックが有効になっている場合、パーツ取り出し確認は無効になります',
      enabled: 'パーツ取り出し確認有効',
      disabled: 'パーツ取り出し確認無効',
      submittedBy: '{{user}}により投稿',
      started: '開始',
      completed: '完了',
      collectButton: '回収',
      confirmTitle: 'パーツ取り出しを確認',
