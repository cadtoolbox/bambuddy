export default {
  ...
  printers: {
    ...
    toast: {
      ...
      partRemovalEnabled: 'Part removal confirmation enabled',
      partRemovalDisabled: 'Part removal confirmation disabled',
    ...
    partRemoval: {
      ...
      disabledDuringPlateCheck: 'Part removal confirmation disabled when plate check is enabled',
      enabled: 'Part Removal Confirmation Enabled',
      disabled: 'Part Removal Confirmation Disabled',
