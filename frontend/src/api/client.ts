...
export interface PrintQueueItem {
  ...
  filament_overrides: Array<{ slot_id: number; type: string; color: string; force_color_match?: boolean }> | null;  // Filament overrides for model-based assignment
...
export interface PrintQueueItemCreate {
  ...
  filament_overrides?: Array<{ slot_id: number; type: string; color: string; force_color_match?: boolean }> | null;
